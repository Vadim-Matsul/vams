...
import { BuildCrane } from '@/components/icons/BuildCrane';
...
const config = {
  title: 'Застройщики элитной недвижимости',
  benefits: [
    'Ранний доступ к премиальным новостройкам',
    'Глубокая экспертиза застройщиков и проектов',
    'Переговоры и условия в интересах клиента',
    'Оценка потенциала роста и ликвидности объектов',
  ]
}
...
export function HeroBlock({ }: Props) {
  ...
  return (
    ...
    >
          ...
          <div>
            <div
              className={cn(
                ...
                'py-2 px-3 rounded-[10px] sm:whitespace-nowrap sm:w-min'
              )}
            >
              <h1
                className={cn(
      ...
      >
        <img
          src='/images/services_development.jpg'
