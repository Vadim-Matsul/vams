...
const step_config = [
  {
    title: 'Комплексная<br/>проверка&nbsp;правовых&nbsp;и<br/>инвестиционных&nbsp;рисков',
    desc: '',
  },
  {
    title: 'Подготовка&nbsp;полного<br/>пакета&nbsp;документов<br/>под&nbsp;ключ',
    desc: '',
  },
  {
    title: 'Представление<br/>интересов&nbsp;клиента&nbsp;в<br/>банках&nbsp;и&nbsp;госорганах',
    desc: '',
  },
  {
    title: 'Контроль<br/>корректности&nbsp;всех<br/>этапов&nbsp;сделки',
    desc: '',
  },
  {
    title: 'Гарантия<br/>прозрачности&nbsp;и<br/>правовой&nbsp;защиты<br/>покупки',
    desc: '',
  },
]
