...
const config = {
  ...
  benefits: [
    'Инвестиции с просчётом, а не на интуиции',
    'Персональная стратегия под ваши цели и капитал',
    'Глубокая аналитика рынка и рисков',
    'Сопровождение сделки от выбора до прибыли',
  ]
}
