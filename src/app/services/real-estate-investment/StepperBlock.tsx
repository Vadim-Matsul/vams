...
const step_config = [
  {
    title: 'Прозрачные&nbsp;расчёты<br/>доходности&nbsp;и&nbsp;рисков',
    desc: '',
  },
  {
    title: 'Подбор&nbsp;объектов&nbsp;с<br/>высоким&nbsp;потенциалом<br/>роста',
    desc: '',
  },
  {
    title: 'Персональные<br/>инвестиционные<br/>сценарии&nbsp;под&nbsp;цели<br/>клиента',
    desc: '',
  },
  {
    title: 'Экспертное<br/>сопровождение&nbsp;на<br/>всех&nbsp;этапах&nbsp;сделки',
    desc: '',
  },
  {
    title: 'Управляемая<br/>стратегия&nbsp;вложений&nbsp;с<br/>прогнозом&nbsp;окупаемости',
    desc: '',
  },
]
