...
const config = {
  ...
  benefits: [
    'Точный прогноз цен и тенденций рынка',
    'Аналитика премиальной недвижимости без искажений',
    'Рекомендации по лучшему времени для сделки',
    'Персональная стратегия инвестиций под ваши цели',
  ]
}
...
export function HeroBlock({ }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src='/images/services_investment.jpg'
