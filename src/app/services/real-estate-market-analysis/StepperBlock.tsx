...
const step_config = [
  {
    title: 'Прогноз цен на жильё<br/>в премиальном и<br/>элитном сегменте',
    desc: '',
  },
  {
    title: 'Рекомендации по<br/>выбору оптимального<br/>времени для сделки',
    desc: '',
  },
  {
    title: 'Анализ ликвидности<br/>конкретных объектов',
    desc: '',
  },
  {
    title: 'Обзор рынка<br/>новостроек Москвы и<br/>вторичных<br/>предложений',
    desc: '',
  },
  {
    title: 'Персональная<br/>стратегия инвестиций<br/>в премиальную<br/>недвижимость',
    desc: '',
  },
]
