...
export default function IntroBlock({ }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <span className='text-[24px] leading-none md:hidden'>Премиальная<br />недвижимость<br />с&nbsp;интеллектуальным<br />подходом</span>
        <span className='text-[30px] leading-none hidden md:inline xl:hidden'>Премиальная&nbsp;недвижимость<br />с&nbsp;интеллектуальным<br />подходом</span>
        <span className='text-[48px] leading-none hidden xl:inline'>Премиальная&nbsp;недвижимость<br />с&nbsp;интеллектуальным&nbsp;подходом</span>
      </h2>
