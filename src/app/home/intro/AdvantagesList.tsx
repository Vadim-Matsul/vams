...
//   {
//     
//     img: '/images/advantage_personal.png'
//   },
//   {
//     
//     img: '/images/advantage_support.png'
//   }
// ]
    ...
    >
      ...
      >
        <li
          className={cn(
            'flex',
            'flex-col gap-[30px] pt-[24px] w-[324px] mx-auto',
            'md:flex-row md:pt-0 md:justify-between md:w-auto md:gap-0',
            'xl:w-[1200px]'
          )}
        >
          <div
        ...
        <li
          className={cn(
            'flex',
            'flex-col gap-[12px] pt-[24px] w-[324px] mx-auto',
            'md:flex-row md:pt-0 md:justify-between md:w-auto md:gap-0',
            'xl:w-[1200px]'
          )}
        >
          ...
          >
            <Image
              ...
              alt={'Доступ к закрытым предложениям'}
              fill
              className=''
            />
          </div>
        ...
        <li
          className={cn(
            'flex',
            'flex-col gap-[15px] pt-[24px] w-[324px] mx-auto',
            'md:flex-row md:pt-0 md:justify-between md:w-auto md:gap-0',
            'xl:w-[1200px]'
          )}
        >
          ...
          >
            <Image
              ...
              alt={'Полное юридическое сопровождение'}
              fill
              className=''
            />
          </div>
