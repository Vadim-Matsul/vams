...
const step_config = [
  {
    desc: 'Главные ориентир — ваши потребности. На первой встрече мы внимательно изучаем предпочтения, бюджет и инвестиционные задачи, чтобы создать индивидуальный сценарий поиска. Каждая деталь важна: от локации до долгосрочных целей.',
    title: 'Бриф<br/>и постановка цели',
  },
  {
    title: 'Анализ и подбор объектов',
    desc: 'Исследуем рынок через призму ваших критериев, отсеивая всё лишнее. В фокусе — только те варианты, которые сочетают перспективность, выгодные условия и соответствие истинным ожиданиям.',
  },
  {
    title: 'Презентация и обсуждение',
    desc: 'Вы видите тщательно отобранные предложения с прозрачной аналитикой: расчёты доходности, потенциал роста и полное финансовое обоснование. Никаких неожиданностей — только факты.',
  },
  {
    title: 'Организация просмотров',
    desc: 'В удобном для вас формате — онлайн или с персональным сопровождением. Мы экономим ваше время: трансфер, детальная информация об объекте и ответы на вопросы — без лишних хлопот.',
  },
  {
    title: 'Юридическое сопровождение',
    desc: 'Проверяем историю объекта, документы и правовые нюансы до мелочей. Наша задача — обеспечить абсолютную чистоту сделки и вашу уверенность на каждом этапе.',
  },
  {
    title: 'Сделка и передача ключей',
    desc: 'Полный контроль процесса: от переговоров до регистрации. В назначенный день вы получаете ключи и документы без стресса и с гарантией законности всех процедур.',
  },
]
